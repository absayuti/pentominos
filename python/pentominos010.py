#!/usr/bin/python
"""
    Pentominos for Python 3 (also run in Python 2) with colorconsole package
    Originally Pentominos for Commodore computers by Jim Butterfield, 
    Compute! May 1984. Copied and pasted into CBM Prg Studio on 5th Sept 2015.

    (C) 2015 AB Sayuti HM Saman
    ...
    Algorithm:
				...
				Repeat
					...
					Get next empty spot
					Repeat
						Test piece in empty spot
						If piece fit then
							Place the piece
						Else
							rotate the piece
					Until piece is placed
				Until all filled up		
