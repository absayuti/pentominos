...
# Need pygame 2.9a ... install correct version for your python
"""
-------------------------------------------------------------------------------
	Pentominos 
	...
	0.30	24-10-15	Another go at graphical user input...
...
# Colour global constants ... should we sample ZX spectrum's colours?
...
def initialize():
	...
	# Put them in an array so taht we can cycle through themn easily
	global colour
	colour		= []
...
def get_user_selection():
	...
	while True:
		...
		b0=pygame.font.SysFont("verdana",48)
		b1=pygame.font.SysFont("tahoma",32)
		b3=pygame.font.SysFont("verdana",36)
		b4=pygame.font.SysFont("verdana",36)
		b5=pygame.font.SysFont("verdana",36)
		b6=pygame.font.SysFont("verdana",36)
		r3=Rect((100,150),b3.size("Press 3 for 3x20 board "))
		r4=Rect((100,200),b4.size("Press 4 for 4x15 board "))
		r5=Rect((100,250),b5.size("Press 5 for 5x12 board "))
		r6=Rect((100,300),b6.size("Press 6 for 6x10 board "))
		window.blit(b0.render("PENTOMINOES",True,RED),(100,50))
		window.blit(b1.render("Select Board Size",True,WHITE),(100,100))
		# highlight option if mouse over
		if r3.collidepoint(pygame.mouse.get_pos()):
			window.blit(b3.render("Press 3 for 3x20 board",True,MAGENTA,WHITE),(100,150))
		else:
			window.blit(b3.render("Press 3 for 3x20 board",True,MAGENTA,BLACK),(100,150))
		if r4.collidepoint(pygame.mouse.get_pos()):
			window.blit(b4.render("Press 4 for 4x15 board",True,GREEN,WHITE),(100,200))
		else:
			window.blit(b4.render("Press 4 for 4x15 board",True,GREEN,BLACK),(100,200))
		if r5.collidepoint(pygame.mouse.get_pos()):
			window.blit(b5.render("Press 5 for 5x12 board",True,CYAN,WHITE),(100,250))
		else:
			window.blit(b5.render("Press 5 for 5x12 board",True,CYAN,BLACK),(100,250))
		if r6.collidepoint(pygame.mouse.get_pos()):
			window.blit(b6.render("Press 6 for 6x10 board",True,YELLOW,WHITE),(100,300))
		else:
			window.blit(b6.render("Press 6 for 6x10 board",True,YELLOW,BLACK),(100,300))
		pygame.display.flip()
		# Check for use click --> selection
		if press[K_3] or  (r3.collidepoint(pygame.mouse.get_pos()) and mousepress[0]):
			boardHEIGHT	= 3
			break
		if press[K_4] or  (r4.collidepoint(pygame.mouse.get_pos()) and mousepress[0]):
			boardHEIGHT	= 4
			break
		if press[K_5] or  (r5.collidepoint(pygame.mouse.get_pos()) and mousepress[0]):
			boardHEIGHT	= 5
			break
		if press[K_6] or  (r6.collidepoint(pygame.mouse.get_pos()) and mousepress[0]):
			boardHEIGHT	= 6
			break
