...
pieceno 	= [0 for x in range(12)]
						# Which piece P is placed in slotno S?
rotation	= [0 for x in range(12)]
...
def main():
	...
	while slotno < 12:
		...
		while tries < 12:
			...
			print('                                                                ')			
			gotoxy(1,2)
			print('Full',full,'S',slotno,'P',nextpiece,'try',tries)
			input()
			if fit:
				...
				gotoxy(30,2)
				print('S',slotno,'P',pieceno[slotno],'R',rotation[slotno])
				input()
				slotno = slotno+1
				prevpiece = nextpiece
				break
